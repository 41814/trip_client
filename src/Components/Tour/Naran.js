...
const Naran = () => {
  const images = [
    { src: 'naran1.jpeg', alt: 'Lahore - Badshahi Mosque' },
    { src: 'naran2.jpeg', alt: 'Destination 2' },
    { src: 'naran3.jpeg', alt: 'Destination 3' },
    { src: 'naran4.jpeg', alt: 'Destination 4' },
    { src: 'naran5.jpeg', alt: 'Destination 5' },
  ];
    ...
    <>
      <header className="header5">
        <div className="header-background5">
          <img src="nara.jpg" alt="Pakistan Landscape" />
        </div>
